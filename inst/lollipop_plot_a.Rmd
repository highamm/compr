...
plot_win_perc_with_error_bars <- function(model, data, player_of_interest) {
  ...
  joined_df_1 <- joined_df %>% 
    mutate( 
      se = 0.05  # You can adjust the 'se' value here
      # You can also uncomment and use any other method to calculate 'se'
    ) %>%
...
plot_win_perc_with_error_bars(comp_mod, nba_game, 'New York Knicks')
```
