...
The purpose of the `compr_james` package is to provide functionality for fitting paired competition models in `R`. The primary function, `comp_glm()` has the following arguments:
